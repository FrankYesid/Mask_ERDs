...
%   F. Y. Zapata C. 2019 
%%
function [maxi,mini]=Graficas_ERDs_channels_giga(r,ERDsfilt_,erdcolormap,labels,labels2,name,sav,Dir_save)
...
%             r{fold}{clas}.ERDS{plot_index(counter_plots11)}.erds(xx,yy) = -1;
                   ...
                   imagesc(-2:1/512:5,1:17, ERDsfilt_{fold}{clas}{channels(counter_plots11)}, [-1, 1.5]);
...
%             title('C$_{4}$','FontSize',15,'Interpreter','latex')
        ...
        if clas == 2
            ...
            if counter_plots == 1 || counter_plots == 3
