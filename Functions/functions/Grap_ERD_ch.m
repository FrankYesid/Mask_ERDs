...
%          Se encuentra en la estructura ... r {fold}{class}{ch}(frequency,samples)
...
for clas = 1:2
    ...
    for i_cols = 1:length(plot_index)
        ...
        if strcmp(r{fold}{clas}.refmethod, 'absolute')
            imagesc(r{fold}{clas}.t_plot, r{fold}{clas}.f_plot, ra{fold}{clas}.ERDS{plot_index(counter_plots11)}.erds'); % r.ERDS{counter_plots}.erds'
        else
            imagesc(r{fold}{clas}.t_plot, r{fold}{clas}.f_plot, ra{fold}{clas}.ERDS{plot_index(counter_plots11)}.erds', [-1, 1.5]);
        end;
        ...
        if counter_plots == 1 || counter_plots == 4
            ...
            a{counter_plots}.YTick=r{fold}{clas}.f_plot;
            a{counter_plots}.YTickLabel = r{fold}{clas}.f_plot;
